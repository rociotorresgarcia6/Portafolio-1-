...
<template>
  <section class="mx-auto max-w-5xl space-y-6 px-4 py-10 sm:px-6 sm:py-14">
    <Button variant="ghost" class="px-0" @click="handleBack">
    ...
    <article v-if="project" class="overflow-hidden rounded-2xl border border-slate-200 bg-white">
      ...
      <div class="space-y-4 p-6 sm:p-8">
        ...
        <h1 class="font-['Arial_Black',Arial,sans-serif] text-4xl leading-tight">{{ project.title }}</h1>
        <p class="max-w-3xl font-['Helvetica_Neue',Helvetica,Arial,sans-serif] italic text-slate-700">
          {{ project.summary }}
        </p>
